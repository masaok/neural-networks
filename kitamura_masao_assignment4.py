...
# n_epoch = 20   # Too small (per Dr. Wong)
...
with tf.Graph().as_default():
  ...
  learning_rate_start = 3e-3  # changing this step size (started at 1e-4)
  learning_rate_end = 5e-4   # Started at 1e-5, but a smaller end is higher accuracy
  ...
  # Layer loop
  my_outputs = [48, 32, 16, 16]  # Per Dr. Wong
  # while num_outputs > 10:
  for num_outputs in my_outputs:
